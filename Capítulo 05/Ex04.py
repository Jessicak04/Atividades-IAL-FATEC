#4. Faça um programa que inicialize uma lista vazia e a preencha com 5 nomes 
# diferentes digitados pelo usuário, depois disso solicite um número de 0 até 4 e 
